...
public class ConnectionSpy implements Connection, Spy
{
  ...
  public void rollback(Savepoint savepoint) throws SQLException
  {
    ...
    try
    {
      ...
      log.connectionTranscation(this, methodCall, "rollback transcation to savepoint");
    }
    catch (SQLException s)
    {
      reportException(methodCall, s);
  ...
  public void setAutoCommit(boolean autoCommit) throws SQLException
  {
    ...
    try
    {
      ...
      log.connectionTranscation(this, methodCall, autoCommit ? "auto commit transcation" : "not auto commit transcation");
    }
    catch (SQLException s)
    {
      reportException(methodCall, s);
  ...
  public void commit() throws SQLException
  {
    ...
    try
    {
      ...
      log.connectionTranscation(this, methodCall, "commit transcation");
    }
    catch (SQLException s)
    {
      reportException(methodCall, s);
  ...
  public void rollback() throws SQLException
  {
    ...
    try
    {
      ...
      log.connectionTranscation(this, methodCall, "rollback transcation");
    }
    catch (SQLException s)
    {
      reportException(methodCall, s);
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException
  {
	...
	public void abort(Executor arg0) throws SQLException {
		String methodCall = "abort(" + arg0 + ")";
		try {
			realConnection.abort(arg0);
	...
	public void setNetworkTimeout(Executor arg0, int arg1) throws SQLException {
		String methodCall = "setNetworkTimeout(" + arg0 + ", " + arg1 + ")";
		try {
			realConnection.setNetworkTimeout(arg0, arg1);
		} catch (SQLException e) {
			reportException(methodCall, e);
			throw e;
		}
	...
	public void setSchema(String arg0) throws SQLException {
		String methodCall = "setSchema(" + arg0 + ")";
		try {
			realConnection.setSchema(arg0);
		} catch (SQLException e) {
			reportException(methodCall, e);
			throw e;
		}
