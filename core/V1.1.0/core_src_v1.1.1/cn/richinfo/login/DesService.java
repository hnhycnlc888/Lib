...
public class DesService {
	/** 加密、解密key. */  
    private static final String PASSWORD_CRYPT_KEY = ConfigHelper.getInstance().readLogin("SsoApi/key");  
    /** 加密算法,可用 DES,DESede,Blowfish. */  
    private final static String ALGORITHM = "DES";  
    public static void main(String[] args) throws Exception {  
        String md5Password = "13726273429";  
        String str = DesService.encrypt(md5Password);  
        System.out.println("str: " + str);  
        str = DesService.decrypt(str);  
        System.out.println("str: " + str);  
    }  
